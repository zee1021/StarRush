...
def main():
    ...
    pygame.display.set_caption('Star Rush')
    BASICFONT = pygame.font.Font('freesansbold.ttf', 18)

    # A global dict value that will contain all the Pygame
    # Surface objects returned by pygame.image.load().
    IMAGESDICT = {'uncovered goal': pygame.image.load('Red_base.png'),
                  'covered goal': pygame.image.load('Yellow_base.png'),
    ...
    levels = readLevelsFile('StarRush_Levels.txt')
    currentLevelIndex = 0
